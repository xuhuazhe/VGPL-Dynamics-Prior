...
kernprof -l control_3d.py \
	--env Gripper \
	--data_type ngrip_3d_fixed_v3 \
	--stage control \
	--outf_control dump/dump_ngrip_3d_fixed_v3/files_dy_18-Jan-2022-14:03:41.135513_nHis4_aug0.05_gt0_seqlen6_emd0.9_chamfer0.1_uh0.0_clip0.0 \
